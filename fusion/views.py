...
def mess(request, emp_id):
    ...
    return render(request, 'fusion/messModule/mess.html', context)


def complaint(request, emp_id):
    employeePK = emp_id
    dbUser = get_object_or_404(Employee, pk=employeePK)
    userFirstName = str(dbUser.empFirstName)
    userLastName = str(dbUser.empLastName)
    ...
    return render(request, 'fusion/complaintModule/complaint.html', context)
